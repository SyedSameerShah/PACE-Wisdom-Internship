...
if __name__ == '__main__':
    ...
    brightened_im = adjust_brighteness(lake, 1.9)
    brightened_im.write_image('brigthened.png')

    darken_im = adjust_brighteness(lake, 0.4)
    darken_im.write_image('darkened.png')

    increase_contrast = adjust_contrast(lake, 2, 0.7)
    increase_contrast.write_image('increased_con.png')

    decrease_contrast = adjust_contrast(lake, 0.5, 0.7)
